/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/api/wrangler.jsonc --env=staging` (hash: c954b37bcf13bebd6f2446a57d34e1d6)
// Runtime types generated with workerd@1.20260623.1 2026-05-22 nodejs_compat
interface __BaseEnv_Env {
  DB: D1Database;
  ISOTOPE_QUEUE: Queue;
  PROFILE_PARSE_LIMITER: RateLimit;
  AI: Ai;
  ALLOWED_CORS_ORIGIN: "http://localhost:3000,https://isotope-web-staging.hatiprithwish.workers.dev,chrome-extension://nnfihnmmhkbcmmpjigikafckdkcpjnni";
